...
TIER_RANK = {t: i for i, t in enumerate(TIERS)}  # Bronze=0 … Legend=4

SKILL_NAMES = [
    # Hitting
    "Contact", "Power", "Speed", "Fielding", "Arm Strength", "Vision",
    "Clutch", "BB/K", "vs LHP", "vs RHP", "HR Power", "Gap Power",
    # Pitching
    "Velocity", "Movement", "Control", "Stamina", "Hold Runner", "vs LHB", "vs RHB",
]
